...
async function getAllGrades() {
    ...
    */
    let allStudents = new Set(); // Creates a Collection
    ...
    /*
     Not the best practice 
    */
    let allSubjects = new Set(); // Creates a Collection
    ...
    /*
     Not the best practice 
    */
    let allGradeTypes = new Set(); // Creates a Collection
    ...
    */
    ...
    allCombinations.forEach(({student, subject, type}) => {
        /*
         Get every combination and verifies if one of them is not in the api 
        */
        ...
        /*
         If grade is not in the api this tells that is deleted. 
        */
        if (!hasItem) {
            grades.push({
                id: nextId++,
